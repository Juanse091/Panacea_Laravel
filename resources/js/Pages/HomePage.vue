    ...
    <PanaceaLayout>
            ...
            <div class="categories_container">
                <swiper :slidesPerView="3" :spaceBetween="50" :pagination="{
                    ...
                    <swiper-slide v-for="categoria in categorias" key="categoria.ID">
                        <categorie :nombre="categoria.Nombre_Categoria" :img="categoria.URL_Img" :id="categoria.ID">
                        </categorie>
                    </swiper-slide>
                </swiper>
            </div>
        ...
        <section class="featured_section">
            ...
            <div class="fp_container">
                ...
                <swiper :slidesPerView="3" :spaceBetween="50" :navigation="true" :breakpoints="{
                    '600': {
                        slidesPerView: 3,
                    },
                    '100': {
                    ...
                    <swiper-slide v-for="(producto) in productos.slice(0, 5)" key="producto.id">
                        <product :nombre="producto.Nombre_Producto" :img="producto.URL_Img" :precio="producto.Precio"
                            :id="producto.Codigo"></product>
                    </swiper-slide>
                </swiper>
            </div>
        </section>
